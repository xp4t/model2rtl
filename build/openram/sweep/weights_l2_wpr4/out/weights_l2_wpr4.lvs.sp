...
.SUBCKT weights_l2_wpr4_rom_base_zero_cell
+ bl wl gnd
* INOUT : bl 
* INPUT : wl 
* GROUND: gnd 
Xweights_l2_wpr4_rom_base_zero_cell_nmos bl wl bl gnd sky130_fd_pr__special_nfet_01v8 m=1 w=0.36u l=0.15u
.ENDS weights_l2_wpr4_rom_base_zero_cell

.SUBCKT weights_l2_wpr4_rom_base_one_cell
+ bl_h bl_l wl gnd
* INOUT : bl_h 
* INOUT : bl_l 
* INPUT : wl 
* GROUND: gnd 
Xweights_l2_wpr4_rom_base_one_cell_nmos bl_h wl bl_l gnd sky130_fd_pr__special_nfet_01v8 m=1 w=0.36u l=0.15u
.ENDS weights_l2_wpr4_rom_base_one_cell

* spice ptx X{0} {1} sky130_fd_pr__pfet_01v8 m=1 w=0.42 l=0.15 pd=1.14 ps=1.14 as=0.16u ad=0.16u

.SUBCKT weights_l2_wpr4_precharge_cell
+ vdd gate bitline
* POWER : vdd 
* INPUT : gate 
* OUTPUT: bitline 
Xprecharge_pmos bitline gate vdd vdd sky130_fd_pr__pfet_01v8 m=1 w=0.42u l=0.15u
.ENDS weights_l2_wpr4_precharge_cell

.SUBCKT weights_l2_wpr4_rom_precharge_array
...
+ weights_l2_wpr4_precharge_cell
Xpmos_c1
...
+ weights_l2_wpr4_precharge_cell
.ENDS weights_l2_wpr4_rom_precharge_array

.SUBCKT weights_l2_wpr4_rom_base_array
...
Xbit_r0_c0
+ bl_0_0 wl_0_0 gnd
+ weights_l2_wpr4_rom_base_zero_cell
Xbit_r0_c1
+ bl_int_0_1 bl_0_1 wl_0_0 gnd
+ weights_l2_wpr4_rom_base_one_cell
Xbit_r0_c2
...
+ weights_l2_wpr4_rom_precharge_array
.ENDS weights_l2_wpr4_rom_base_array
...
.SUBCKT weights_l2_wpr4_inv_array_mod
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_inv_array_mod

.SUBCKT weights_l2_wpr4_rom_address_control_buf
...
+ sky130_fd_bd_sram__openram_sp_nand2_dec
.ENDS weights_l2_wpr4_rom_address_control_buf

.SUBCKT weights_l2_wpr4_rom_address_control_array
...
+ weights_l2_wpr4_rom_address_control_buf
XXaddr_buf_1
...
.ENDS weights_l2_wpr4_pinv_dec_0

* spice ptx X{0} {1} sky130_fd_pr__nfet_01v8 m=1 w=7.0 l=0.15 pd=14.30 ps=14.30 as=2.62u ad=2.62u

.SUBCKT weights_l2_wpr4_pinv_dec_1
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_pinv_dec_1

.SUBCKT weights_l2_wpr4_pbuf_dec
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
Xbuf_inv1
+ A zb_int vdd gnd
+ weights_l2_wpr4_pinv_dec_0
Xbuf_inv2
+ zb_int Z vdd gnd
+ weights_l2_wpr4_pinv_dec_1
.ENDS weights_l2_wpr4_pbuf_dec

.SUBCKT weights_l2_wpr4_rom_row_decode_wordline_buffer
...
+ in_7 out_7 vdd gnd
+ weights_l2_wpr4_pbuf_dec
.ENDS weights_l2_wpr4_rom_row_decode_wordline_buffer

.SUBCKT weights_l2_wpr4_rom_precharge_array_0
+ pre_bl0_out pre_bl1_out pre_bl2_out pre_bl3_out pre_bl4_out
...
+ vdd gate pre_bl7_out
+ weights_l2_wpr4_precharge_cell
.ENDS weights_l2_wpr4_rom_precharge_array_0

.SUBCKT weights_l2_wpr4_rom_row_decode_array
...
+ weights_l2_wpr4_rom_precharge_array_0
.ENDS weights_l2_wpr4_rom_row_decode_array

.SUBCKT weights_l2_wpr4_rom_row_decode
...
+ weights_l2_wpr4_rom_row_decode_array
Xpre_control_array
+ A0 A1 A2 A_int_0 A_int_1 A_int_2 Ab_int_0 Ab_int_1 Ab_int_2 clk vdd
+ gnd
+ weights_l2_wpr4_rom_address_control_array
...
+ weights_l2_wpr4_rom_row_decode_wordline_buffer
.ENDS weights_l2_wpr4_rom_row_decode
...
.SUBCKT weights_l2_wpr4_pinv_dec_3
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_pinv_dec_3

.SUBCKT weights_l2_wpr4_rom_bitline_inverter
...
+ weights_l2_wpr4_pinv_dec_3
.ENDS weights_l2_wpr4_rom_bitline_inverter
...
.SUBCKT weights_l2_wpr4_rom_control_nand
+ A B Z vdd gnd
* INPUT : A 
* INPUT : B 
* OUTPUT: Z 
...
.ENDS weights_l2_wpr4_rom_control_nand

* spice ptx X{0} {1} sky130_fd_pr__pfet_01v8 m=2 w=1.26 l=0.15 pd=2.82 ps=2.82 as=0.47u ad=0.47u

* spice ptx X{0} {1} sky130_fd_pr__nfet_01v8 m=2 w=0.74 l=0.15 pd=1.78 ps=1.78 as=0.28u ad=0.28u

.SUBCKT weights_l2_wpr4_pinv_0
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_pinv_1

* spice ptx X{0} {1} sky130_fd_pr__pfet_01v8 m=1 w=1.12 l=0.15 pd=2.54 ps=2.54 as=0.42u ad=0.42u

* spice ptx X{0} {1} sky130_fd_pr__special_nfet_01v8 m=1 w=0.36 l=0.15 pd=1.02 ps=1.02 as=0.14u ad=0.14u

.SUBCKT weights_l2_wpr4_pinv
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_pinv

.SUBCKT weights_l2_wpr4_rom_clock_driver
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
Xbuf_inv1
+ A Zb1_int vdd gnd
+ weights_l2_wpr4_pinv
Xbuf_inv2
+ Zb1_int Zb2_int vdd gnd
+ weights_l2_wpr4_pinv
Xbuf_inv3
+ Zb2_int Zb3_int vdd gnd
+ weights_l2_wpr4_pinv_0
Xbuf_inv4
+ Zb3_int Z vdd gnd
+ weights_l2_wpr4_pinv_1
.ENDS weights_l2_wpr4_rom_clock_driver
...
* GROUND: gnd 
* size: 57
Xpinv_pmos Z A vdd vdd sky130_fd_pr__pfet_01v8 m=21 w=3.0u l=0.15u
Xpinv_nmos Z A gnd gnd sky130_fd_pr__nfet_01v8 m=21 w=3.0u l=0.15u
.ENDS weights_l2_wpr4_pinv_4

* spice ptx X{0} {1} sky130_fd_pr__pfet_01v8 m=4 w=2.0 l=0.15 pd=4.30 ps=4.30 as=0.75u ad=0.75u

* spice ptx X{0} {1} sky130_fd_pr__nfet_01v8 m=4 w=1.26 l=0.15 pd=2.82 ps=2.82 as=0.47u ad=0.47u

.SUBCKT weights_l2_wpr4_pinv_2
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
.ENDS weights_l2_wpr4_pinv_3

.SUBCKT weights_l2_wpr4_rom_precharge_driver
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
+ weights_l2_wpr4_pinv_2
Xbuf_inv6
+ Zb5_int Zb6_int vdd gnd
+ weights_l2_wpr4_pinv_3
Xbuf_inv7
+ Zb6_int Z vdd gnd
+ weights_l2_wpr4_pinv_4
.ENDS weights_l2_wpr4_rom_precharge_driver

.SUBCKT weights_l2_wpr4_rom_control_logic
...
+ weights_l2_wpr4_rom_clock_driver
Xcontrol_nand
+ CS clk_out pre_drive vdd gnd
+ weights_l2_wpr4_rom_control_nand
Xprecharge_driver
+ pre_drive prechrg vdd gnd
+ weights_l2_wpr4_rom_precharge_driver
.ENDS weights_l2_wpr4_rom_control_logic

.SUBCKT weights_l2_wpr4_pinv_dec_2
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
Xpinv_pmos Z A vdd vdd sky130_fd_pr__pfet_01v8 m=1 w=3.0u l=0.15u
Xpinv_nmos Z A gnd gnd sky130_fd_pr__nfet_01v8 m=1 w=0.74u l=0.15u
.ENDS weights_l2_wpr4_pinv_dec_2

.SUBCKT weights_l2_wpr4_rom_column_decode_wordline_buffer
...
+ in_3 out_3 vdd gnd
+ weights_l2_wpr4_pinv_dec_2
.ENDS weights_l2_wpr4_rom_column_decode_wordline_buffer

.SUBCKT weights_l2_wpr4_rom_address_control_array_0
...
+ A1_in A1_out Abar1_out clk vdd gnd
+ weights_l2_wpr4_rom_address_control_buf
.ENDS weights_l2_wpr4_rom_address_control_array_0

.SUBCKT weights_l2_wpr4_rom_precharge_array_1
...
+ vdd gate pre_bl3_out
+ weights_l2_wpr4_precharge_cell
.ENDS weights_l2_wpr4_rom_precharge_array_1

.SUBCKT weights_l2_wpr4_rom_column_decode_array
...
+ weights_l2_wpr4_rom_precharge_array_1
.ENDS weights_l2_wpr4_rom_column_decode_array

.SUBCKT weights_l2_wpr4_rom_column_decode
...
+ precharge vdd gnd
+ weights_l2_wpr4_rom_column_decode_array
Xpre_control_array
+ A0 A1 A_int_0 A_int_1 Ab_int_0 Ab_int_1 clk vdd gnd
+ weights_l2_wpr4_rom_address_control_array_0
Xrom_wordline_driver
+ wl_int0 wl_int1 wl_int2 wl_int3 wl_0 wl_1 wl_2 wl_3 vdd gnd
+ weights_l2_wpr4_rom_column_decode_wordline_buffer
.ENDS weights_l2_wpr4_rom_column_decode

* spice ptx X{0} {1} sky130_fd_pr__nfet_01v8 m=1 w=2.88 l=0.15 pd=6.06 ps=6.06 as=1.08u ad=1.08u

.SUBCKT weights_l2_wpr4_rom_column_mux
+ bl bl_out sel gnd
* INOUT : bl 
* INOUT : bl_out 
* INOUT : sel 
...
.ENDS weights_l2_wpr4_rom_column_mux

.SUBCKT weights_l2_wpr4_rom_column_mux_array
...
+ weights_l2_wpr4_rom_column_mux
XXMUX1
...
+ weights_l2_wpr4_rom_column_mux
.ENDS weights_l2_wpr4_rom_column_mux_array

.SUBCKT weights_l2_wpr4_pinv_dec_4
+ A Z vdd gnd
* INPUT : A 
* OUTPUT: Z 
* POWER : vdd 
...
Xpinv_pmos Z A vdd vdd sky130_fd_pr__pfet_01v8 m=1 w=5.0u l=0.15u
Xpinv_nmos Z A gnd gnd sky130_fd_pr__nfet_01v8 m=1 w=1.68u l=0.15u
.ENDS weights_l2_wpr4_pinv_dec_4

.SUBCKT weights_l2_wpr4_rom_output_buffer
+ in_0 in_1 in_2 in_3 in_4 in_5 in_6 in_7 in_8 in_9 in_10 in_11 in_12
+ in_13 in_14 in_15 in_16 in_17 in_18 in_19 in_20 in_21 in_22 in_23
+ in_24 in_25 in_26 in_27 in_28 in_29 in_30 in_31 in_32 in_33 in_34
...
+ in_39 out_39 vdd gnd
+ weights_l2_wpr4_pinv_dec_4
.ENDS weights_l2_wpr4_rom_output_buffer

.SUBCKT weights_l2_wpr4
...
+ weights_l2_wpr4_rom_bitline_inverter
...
+ vccd1 vssd1
+ weights_l2_wpr4_rom_output_buffer
.ENDS weights_l2_wpr4
